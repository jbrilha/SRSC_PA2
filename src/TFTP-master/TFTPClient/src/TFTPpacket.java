...
public class TFTPpacket {
  ...
  public static int maxTftpPakLen=1024; // PA1: changed max packet length
  ...
  public static TFTPpacket receive(DSTPDatagramSocket sock) throws IOException { // PA1: changed socket class
  ...
  public void send(InetAddress ip, int port, DSTPDatagramSocket s) throws IOException { // PA1: changed socket class
